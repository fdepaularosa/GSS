...
we reject the null because the p value is less than 0.05 so that means gun ownership and opinion of capital punishment are related. Fisher's Exact test shows that out of the gun owners, 2.27 percent of gun owners will favor capital punishment
...
$H_0$: a person's performance on a WORDSUM test is not independent of their DEGREE
$H_A$: a person's performance on a WORDSUM test is independent of their DEGREE
...
The numerical descriptive results show that when the level of degree increases, the better their performance on the WORDSUM test is.
...
I reject the null because Pr(\>F) 2.5e-07 is less than 0.05 which means that DEGREE has a significant effect on the WORDSUM test so they are related.
